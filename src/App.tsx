...
function App() {
	...
	const handleAddTransaction = (description: string, amount: number, category: Category, type: "income" | "expense") => {
	...
	return (
		<div className="app">
			...
			<footer className="app-footer">Built with React + TypeScript — IT 431 Advanced Web Development</footer>
		</div>
	);
}
